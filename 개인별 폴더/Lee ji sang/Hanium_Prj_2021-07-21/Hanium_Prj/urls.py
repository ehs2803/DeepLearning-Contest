...
urlpatterns = [
    ...
    path("question_list/", views.question_list, name="question_list"),      # 게시판 제목 페이지 url 연결
    path('<int:question_id>/', views.detail, name='detail'),                # 게시판 제목클릭후 내용뜨는 url
    path('answer/create/<int:question_id>/', views.answer_create, name='answer_create'), #답변등록 url
    path('question/create/', views.question_create, name='question_create'), #질문 등록 url
